...
const ThreeCardSchema = new mongoose.Schema({
    ...
    past_card_interperatation: {type: String, required: true},
    present_card: {type: String, required: true},
    present_card_interperatation: {type: String, required: true},
    future_card: {type: String, required: true},
    future_card_interperatation: {type: String, required: true},
    general_interperatation: {type: String, required: true},
    }, 
    {
    timestamps: true
    }
